...
KUBEADM_VERSION: 1.20.15 #kubeadm版本
HARBOR_DOMAIN: harbor.raymonds.cc
...
#calico配置文件，根据自己需求去替换文件,如果替换文件，请参考博客去修改文件
...
#metrics配置文件，根据自己需求去替换文件，如果替换文件，请参考博客去修改文件
...
#dashboard配置文件，根据自己需求去替换文件，如果替换文件，请参考博客去修改文件
